      ...
      <Container>
        ...
        <Col md={4} className="project-card">
            <ProjectCard
              imgPath={reImg}
              isBlog={false}
              title="OpenCV Project for LEAP using Python"
              description="Developed a Automatic Headlight Dimmer with OPencv and Python that automatically detects the vehicles during night and switches our headlight from bright to dim. It was implemented using a raspberry pi 3 and a camera module."
